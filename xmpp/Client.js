...
module.exports = class Client extends EventEmitter {
    ...
    handleauth(message) {
        ...
        this.botJid = `VanillaBot@prod.ol.epicgames.com/V2:Fortnite:WIN::${parsed[0]}`
    ...
    handlemessage(message) {
        if (message.root.attributes.type == "chat") {
            ...
            if (msg == "!help" || msg == "!Help")
            {
                ...
                '!AddLobby    Add A Full Party Of Bots' + '\n' +
                ...
                if (this.NumberOfBot == 0) {
                    this.AddOneBot("VanillaBot")
                    this.AddOneBot("hqlo")
                }
                else {
                    this.AddOneBot("Blitz")
                    this.AddOneBot("Strawberry")
                    this.AddOneBot("RJRCool5")
                    this.AddOneBot("...Sqarkle")
                }
            ...
            if (msg.startsWith("!skin ")) {
                ...
                axios.get(`https://fortnite-api.com/v2/cosmetics/br/search?name=${name}&matchMethod=contains&type=outfit`).then(response => {
                    ...
                    fs.writeFile('./config/VanillaBot/config.json', JSON.stringify({
            ...
            if (msg.startsWith("!backpack " || msg.startsWith("!Backpack "))) {
                ...
                axios.get(`https://fortnite-api.com/v2/cosmetics/br/search?name=${name}&matchMethod=contains&type=backpack`).then(response => {
                    this.setAllbotBackBling(`/Game/Athena/Items/Cosmetics/Backpacks/${response.data.data.id}.${response.data.data.id}`, "VanillaBot")
                }).catch(error => {
                    if (error.response) {
                        axios.get(`https://fortnite-api.com/v2/cosmetics/br/search?name=${name}&matchMethod=contains&type=PET`).then(response => {
                            this.setAllbotBackBling(`/Game/Athena/Items/Cosmetics/PetCarriers/${response.data.data.id.replace(/BID/g, 'PetCarrier')}.${response.data.data.id.replace(/BID/g, 'PetCarrier')}`, "VanillaBot")
                        }).catch(error => {
            ...
            'message': {
                ...
                'body': {
                    "#text": JSON.stringify({
                        ...
                        "ns": "Fortnite",
                        "party_id": partyID,
                        "account_id": "VanillaBot",
                        "account_dn": "VanillaBot",
                        "member_state_updated": {
                            "urn:epic:member:dn_s": "VanillaBot",
                            "urn:epic:member:joinrequestusers_j": "{\"users\":[{\"id\":\"VanillaBot\",\"dn\":\"VanillaBot\",\"plat\":\"WIN\",\"data\":\"{\\\"CrossplayPreference_i\\\":\\\"1\\\",\\\"SubGame_u\\\":\\\"1\\\"}\"}]}"
                        },
                        "joined_at": new Date(),
                        "updated_at": new Date()
                    })
    ...
    JoinBot(PartyId) {
        ...
        setTimeout(() => {
                        ...
                        "#text": JSON.stringify(
                            {
                                ...
                                "member_state_updated": {
                                    ...
                                    "Default:AthenaBannerInfo_j": "{\"AthenaBannerInfo\":{\"bannerIconId\":\"BRSeason01\",\"bannerColorId\":\"defaultcolor12\",\"seasonLevel\":69}}",
            ...
            try {
                global.BotConfig = JSON.parse(fs.readFileSync('./config/VanillaBot/config.json', 'utf8', function (err, data) {
                    ...
                    "#text": JSON.stringify(
                        {
                            ...
                            "type": "com.epicgames.social.party.notification.v0.MEMBER_JOINED",
                            "connection": {
                                "id": `VanillaBot${this.NumberOfBot}@prod.ol.epicgames.com/V2:Fortnite:WIN::BOT${this.NumberOfBot}`,
                                "meta": {
                                    "urn:epic:conn:platform_s": "WIN",
                                    "urn:epic:conn:type_s": "game"
                                },
                            ...
                            "ns": "Fortnite",
                            "party_id": PartyId,
                            "account_id": `VanillaBot${this.NumberOfBot}`,
                            "account_dn": `VanillaBot`,
                            "member_state_updated": {
                                "urn:epic:member:joinrequestusers_j": `{\"users\":[{\"id\":\"VanillaBot${this.NumberOfBot}\",\"dn\":\"VanillaBot\",\"plat\":\"WIN\",\"data\":\"{\\\"CrossplayPreference_i\\\":\\\"1\\\",\\\"SubGame_u\\\":\\\"1\\\"}\"}]}`,
                                "urn:epic:member:dn_s": `VanillaBot`
                            },
                            "joined_at": new Date(),
                            "updated_at": new Date()
                        ...
                        "#text": JSON.stringify(
                            {
                                ...
                                "ns": "Fortnite",
                                "party_id": PartyId || "VanillaBot",
                                "account_id": `VanillaBot${counterLol}`,
                                "account_dn": `VanillaBot`,
                                "member_state_removed": [],
                                "member_state_updated": member_state_updated,
                                "joined_at": new Date(),
